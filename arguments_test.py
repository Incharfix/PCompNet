...
def parse_args():
    ...
    parser.add_argument('--root', type=str, default='./Cotton3D/', help='Adam or SGD [default: Adam]')
    #  TrainPoint  DrawPoint
    parser.add_argument('--netG', default='./Pth_FPnet/point_netG150.pth',help="path to netG (to continue training)")
